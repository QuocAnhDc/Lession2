...
<div class="modal fade" id="viewEditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="http://localhost/lession2/?controller=user&action=update" method="POST">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="">ROLE:</label>
            <input type="text" name="uRole" id="edit_uRole" class="form-control" placeholder="Enter Role">
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="deleteUserModal" tabindex="-1" aria-labelledby="deleteUserModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="http://localhost/lession2/?controller=user&action=destroy" method="POST">
        <div class="modal-body">
          <div class="form-group">
            <!-- <label for="">USER ID:</label> -->
            <input type="hidden" name="uId" id="delete_uId" class="form-control">
          </div>
